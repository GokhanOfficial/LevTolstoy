...
const FORMAT_META = {
  pdf:  { label: 'PDF',  color: 'border-red-500/30 bg-red-500/10 text-red-500 hover:bg-red-500/20' },
  html: { label: 'HTML', color: 'border-orange-500/30 bg-orange-500/10 text-orange-500 hover:bg-orange-500/20' },
  md:   { label: 'MD',   color: 'border-sky-500/30 bg-sky-500/10 text-sky-500 hover:bg-sky-500/20' },
}
      ...
      <CardContent className="space-y-3">
        ...
        <div className="flex gap-1.5">
          <button
            ...
            className="flex flex-1 items-center justify-center gap-1.5 rounded-lg border border-border py-1.5 text-xs text-muted-foreground transition-colors hover:border-border hover:text-foreground disabled:opacity-40"
          >
          ...
          <button
            ...
            className="flex flex-1 items-center justify-center gap-1.5 rounded-lg border border-border py-1.5 text-xs text-muted-foreground transition-colors hover:border-indigo-500/50 hover:text-indigo-500 disabled:opacity-40"
          >
